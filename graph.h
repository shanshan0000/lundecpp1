...
public:
    ...
    public:
        ...
        vertex_iterator(typename map<Vertex,set<Vertex> >::const_iterator it):map<Vertex,
                set<Vertex> >::const_iterator(it){}
        const Vertex& operator*() const { return map<Vertex,set<Vertex> >::
            const_iterator::operator*().first; }
    };
    ...
    public:
        ...
        successor_iterator(typename set<Vertex>::const_iterator it):set<Vertex>::const_iterator(it){}
    };
